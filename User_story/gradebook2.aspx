<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gradebook2.aspx.cs" Inherits="User_story.gradebook2" %>
...
<body>
    ...
    <div>
        <h2>Группа АА-11</h2>
        <asp:GridView ID="gvstudent_grade2" runat="server" AutoGenerateColumns="false" DataKeyNames="student_grade_ID" OnRowEditing="gvstudent_grade2_RowEditing" OnRowCancelingEdit="gvstudent_grade2_RowCancelingEdit" OnRowUpdating="gvstudent_grade2_RowUpdating">
            <Columns>
